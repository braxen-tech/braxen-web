...
function Cell() {
  return (
    <div
      aria-hidden="true"
      className="shrink-0 rounded-xl border border-border bg-card/40"
...
function Featured({ src, alt }: { src: string; alt?: string }) {
  return (
    ...
    >
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none absolute inset-0 z-[2] bg-background/20 mix-blend-multiply"
      />
      <div
        aria-hidden="true"
...
export function ScrollReelTestimonials({
  ...
  return (
    <div
      ...
      onKeyDown={onKeyDown}
      className={cn(
        "relative flex w-full max-w-[1060px] flex-col items-stretch gap-2.5 overflow-hidden rounded-xl bg-background outline-none focus-visible:ring-2 focus-visible:ring-ring md:min-h-[320px] md:flex-row",
        className,
      )}
    >
      <div
